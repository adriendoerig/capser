...
for category in test_stimuli.keys():
    ...
    uncrowding_expt_result_sum = np.zeros(shape=(3,))
    for stim in range(3):
        for batch in range(n_expt_batches):
            ...
            uncrowding_expt_result_sum[stim] += vernier_accuracy[0]
            print(batch, uncrowding_expt_result_sum, uncrowding_expt_result, uncrowding_expt_result_sum/n_expt_batches)
    print('###################################################################')
