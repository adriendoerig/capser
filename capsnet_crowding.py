...
from data_handling_functions import make_crowding_sets
...
caps2_n_caps = 2 # number of capsules
...
# to add a layer. I think it works
# caps2_output = fc_to_fc_caps_layer(X,caps2_output,caps2_n_caps,caps2_n_dims,caps2_n_caps,caps2_n_dims,print_shapes=True)
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('caps_logdir',sess.graph)
            ...
            for iteration in range(1, n_iterations_per_epoch + 1):
                ...
                if iteration == n_iterations_per_epoch and epoch is n_epochs:
                    ...
                    sess.run(assignment,feed_dict={X: test_set,
                                                   y: batch_labels,
                                                   mask_with_labels: True})
                    saver.save(sess, os.path.join('caps_logdir','model.ckpt'),epoch)
