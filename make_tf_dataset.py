    ...
    with tf.python_io.TFRecordWriter(out_path) as writer:
        ...
        for i in range(n_samples):
            ...
            for stim in range(n_stim_types):
                config_img, vernier_label = stim_maker.makeConfigBatch(1, configMatrix=stim_matrices[stim], noiseLevel=noise_level, normalize=normalize_images, normalize_sets=normalize_sets,  fixed_position=fixed_stim_position, vernierLabelEncoding='nothinglr_012', random_size=random_size)
